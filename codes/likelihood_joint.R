...
likelihood_joint <- function(lambda, chi_BASE, chi_BEL){
  ...
  treat=(treatment=="BEL")
  sigma_A=qre_probabilities(S_BEL_A,D_BEL,M_BEL,R_BEL,lambda,chi_BEL)
  sigma_B=qre_probabilities(S_BEL_B,D_BEL,M_BEL,R_BEL,lambda,chi_BEL)
  sigma_C=qre_probabilities(S_BEL_C,D_BEL,M_BEL,R_BEL,lambda,chi_BEL)
  sigma_D=qre_probabilities(S_BEL_D,D_BEL,M_BEL,R_BEL,lambda,chi_BEL)
  sigma_E=qre_probabilities(S_BEL_E,D_BEL,M_BEL,R_BEL,lambda,chi_BEL)
